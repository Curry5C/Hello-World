...
<body>
<div id="container">
<h1 class="subject">密码修改</h1>
<form name="form1" id="form1" action="doAction.php?action=change" method="post" onsubmit="return validateForm();">
...
<tr>
<td>新密码:</td>
<td><input type="text" name="password1" id="password1"  class="input"/></td>
</tr>
<tr>
<td>&nbsp;</td>
